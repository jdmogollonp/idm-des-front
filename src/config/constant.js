...
export const API_SERVER_USERS = 'http://localhost:8000/api/';
export const API_SERVER_PROJECTS = 'http://localhost:8001/api/';
export const API_SERVER_PROCESSING = 'http://localhost:8004/';
export const API_SERVER_FLASK = 'http://127.0.0.1:8050/apps';
